 ...
 */
public class Jle extends AsInstruction {
    private final Label label;

    public Jle(Label label) {
        this.label = label;
    }

    @Override
    public String toString() {
        return "jle " + label.getName();
    }
    ...
    public void changeSource(Register reg) {
        throw new UnsupportedOperationException("Cannot change source of Jle");
    }
}
